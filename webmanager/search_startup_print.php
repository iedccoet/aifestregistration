...
<html>
<head>
	<title>STARTUP STARTUP REGISTRATIONS</title>
...
<body>
	...
	<div class="table-control">
		<?php
			...
			$term = $_POST['term'];
			$select = "SELECT * FROM startup WHERE startup_name like '%".$term."%';";
	...
	<br>
	<a href="search_startup.php" class="logout-link">Back To Search</a>
	<br/>
